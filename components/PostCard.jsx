...
const PostCard = ({ post }) => (
        <div className="bg-white shadow-lg rounded-lg padding-0 lg:p-8 pb-12 mb-8">
            ...
            <div className="block lg:flex text-center items-center justify-center mb-8 w-full">
                <div className="flex items-center justify-center mb-4 lg:mb-0 w-full lg:w-auto mr-8">
                    <Image
                        ...
                        alt="{post.ownership.ownershipStatus}"
                        height="30px"
                        width="30px"
                        className="align-middle rounded-full"
                        src={post.ownership.photo.url}
                    />
                    <p className="inline align-middle text-gray-700 ml-2 text-lg">{post.ownership.ownershipStatus}</p>
                </div>
